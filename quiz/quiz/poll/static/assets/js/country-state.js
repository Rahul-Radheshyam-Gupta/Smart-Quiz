...
s_a[236] = "Ajman|Abu Zaby (Abu Dhabi)|Al Fujayrah|Ash Shariqah (Sharjah)|Dubai|Ra's al Khaymah|Umm al Qaywayn";
...
var s_a = [
  ...
  "Tutuila|Aunu'u|Ta'ū|Ofu‑Olosega|Rose Atoll|Swains Island",
  ...
  "Anguilla|Anguillita Island|Blowing Rock|Cove Cay|Crocus Cay|Deadman's Cay|Dog Island|East Cay|Little Island|Little Scrub Island|Mid Cay|North Cay|Prickly Pear Cays|Rabbit Island|Sandy Island/Sand Island|Scilly Cay|Scrub Island|Seal Island|Sombrero/Hat Island|South Cay|South Wager Island|West Cay",
  "Antarctica",
  ...
  "Brest voblast|Gorod Minsk|Homiel voblast|Hrodna voblast|Mahilyow voblast|Minsk voblast|Vitsebsk voblast",
  "Bruxelles-Capitale|Région Flamande|Région Wallonië",
  "Belize District|Cayo District|Corozal District|Orange Walk District|Stann Creek District|Toledo District",
  "Alibori|Atakora|Atlantique|Borgou|Collines Department|Donga|Kouffo|Littoral Department|Mono Department|Ouémé|Plateau|Zou",
  "City of Hamilton|Devonshire Parish|Hamilton Parish|Paget Parish|Pembroke Parish|Sandys Parish|Smith's Parish|Southampton Parish|St. George's Parish|Town of St. George|Warwick Parish",
  ...
  "Bonaire|Saba Isand|Sint Eustatius",
  "Brčko Distrikt|Federacija Bosne i Hercegovine|Republika Srpska",
  "Central|Ghanzi|Kgalagadi|Kgatleng|Kweneng|North West|North-East|South East|Southern",
  "Bouvet Island",
  "Acre|Alagoas|Amapá|Amazonas|Bahia|Ceará|Distrito Federal|Espírito Santo|Goiás|Maranhão|Mato Grosso|Mato Grosso do Sul|Minas Gerais|Para|Paraiba|Paraná|Pernambuco|Piauí|Rio de Janeiro|Rio Grande do Norte|Rio Grande do Sul|Rondônia|Roraima|Santa Catarina|Sao Paulo|Sergipe|Tocantins",
  "British Indian Ocean Territory",
  "Belait|Brunei Muara|Temburong|Tutong",
  "Blagoevgrad|Burgas|Dobrich|Gabrovo|Jambol|Khaskovo|Kjustendil|Kurdzhali|Lovech|Montana|Pazardzhik|Pernik|Pleven|Plovdiv|Razgrad|Ruse|Shumen|Silistra|Sliven|Smoljan|Sofija|Sofija-Grad|Stara Zagora|Turgovishhe|Varna|Veliko Turnovo|Vidin|Vraca",
  "Balé|Bam/Lake Bam|Banwa Province|Bazèga|Bougouriba|Boulgou Province|Boulkiemdé|Comoé/Komoe|Ganzourgou Province|Gnagna|Gourma Province|Houet|Ioba|Kadiogo|Kénédougou|Komondjari|Kompienga|Kossi Province|Koulpélogo|Kouritenga|Kourwéogo|Léraba|Loroum|Mouhoun|Namentenga|Naouri/Nahouri|Nayala|Noumbiel|Oubritenga|Oudalan|Passoré|Poni|Sanguié|Sanmatenga|Séno|Sissili|Soum|Sourou|Tapoa|Tui/Tuy|Yagha|Yatenga|Ziro|Zondoma|Zoundwéogo",
  ...
  "Baat Dambang|Banteay Mean Chey|Kampong Chaam|Kampong Chhnang|Kampong Spueu|Kampong Thum|Kampot|Kandaal|Kaoh Kong|Kracheh|Krong Kaeb|Krong Pailin|Krong Preah Sihanouk|Mondol Kiri|Otdar Mean Chey|Phnom Penh|Pousaat|Preah Vihear|Prey Veaeng|Rotanah Kiri|Siem Reab|Stueng Treng|Svaay Rieng|Taakaev|Tbong Khmum",
  "Adamaoua|Centre|Est|Extrême-Nord|Littoral|Nord|Nord-Ouest|Ouest|Sud|Sud-Ouest",
  "Alberta|British Columbia|Manitoba|New Brunswick|Newfoundland and Labrador|Northwest Territories|Nova Scotia|Nunavut|Ontario|Prince Edward Island|Quebec|Saskatchewan|Yukon",
  "Boa Vista|Brava|Calheta de São Miguel|Maio|Mosteiros|Paúl|Porto Novo|Praia|Ribeira Brava|Ribeira Grande|Sal|Santa Catarina|Santa Cruz|São Domingos|São Filipe|São Nicolau|São Vicente|Tarrafal|Tarrafal de São Nicolau",
  "Creek|Eastern|Midland|South Town|Spot Bay|Stake Bay|West End|Western",
  "Bamingui-Bangoran|Bangui|Basse-Kotto|Haute-Kotto|Haut-Mbomou|Kémo|Lobaye|Mambéré-Kadéï|Mbomou|Nana-Grebizi|Nana-Mambéré|Ombella-M'Poko|Ouaka|Ouham|Ouham Péndé|Sangha-Mbaéré|Vakaga",
  "Bahr el Ghazal|Batha|Borkou|Chari-Baguirmi|Ennedi-Est|Ennedi-Ouest|Guéra|Hadjer Lamis|Kanem|Lac|Logone Occidental|Logone Oriental|Mondoul|Mayo-Kébbi-Est|Moyen-Chari|Ouaddai|Salamat|Sila|Tandjilé|Tibesti|Ville de Ndjamena|Wadi Fira",
  "Aisén del General Carlos Ibáñez del Campo|Antofagasta|Araucanía|Arica y Parinacota|Atacama|Bío-Bío|Coquimbo|Libertador General Bernardo O'Higgins|Los Lagos|Los Ríos|Magallanes y Antartica Chilena|Marga-Marga|Maule|Región Metropolitana de Santiago|Tarapacá|Valparaíso",
  ...
  "Amazonas|Antioquia|Arauca|Archipiélago de San Andrés|Atlántico|Bogotá D.C.|Bolívar|Boyacá|Caldas|Caquetá|Casanare|Cauca|Cesar|Chocó|Córdoba|Cundinamarca|Guainía|Guaviare|Huila|La Guajira|Magdalena|Meta|Nariño|Norte de Santander|Putumayo|Quindío|Risaralda|Santander|Sucre|Tolima|Valle del Cauca|Vaupés|Vichada",
  "Andjazîdja|Andjouân|Moûhîlî",
  ...
  "Agnéby|Bafing|Bas-Sassandra|Denguélé|Dix-Huit Montagnes|Fromager|Haut-Sassandra|Lacs|Lagunes|Marahoué|Moyen-Cavally|Moyen-Comoé|N'zi-Comoé|Savanes|Sud-Bandama|Sud-Comoé|Vallée du Bandama|Worodougou|Zanzan",
  "Bjelovarsko-Bilogorska Županija|Brodsko-Posavska Županija|Dubrovačko-Neretvanska Županija|Grad Zagreb|Istarska Županija|Karlovačka Županija|Koprivničko-Krizevačka Županija|Krapinsko-Zagorska Županija|Ličko-Senjska Županija|Međimurska Županija|Osječko-Baranjska Županija|Požeško-Slavonska Županija|Primorsko-Goranska Županija|Sisačko-Moslavačka Županija|Splitsko-Dalmatinska Županija|Sibensko-Kninska Županija|Varaždinska Županija|Virovitičko-Podravska Županija|Vukovarsko-Srijemska Županija|Zadarska Županija|Zagrebacka Zupanija",
  ...
  "Hovedstaden|Kujalleq|Midtjylland|Norderøerne|Nordjylland|Østerø|Qaasuitsup|Qeqqata|Sandø|Sermersooq|Sjælland|Strømø|Suderø|Syddanmark|Vågø",
  "Ali Sabieh|Arta|Dikhil|Obock|Tadjourah",
  "Saint Andrew Parish|Saint David Parish|Saint George Parish|Saint John Parish|Saint Joseph Parish|Saint Luke Parish|Saint Mark Parish|Saint Patrick Parish|Saint Paul Parish|Saint Peter Parish",
  "Cibao Central|Del Valle|Distrito Nacional|Enriquillo|Norcentral|Nordeste|Noroeste|Norte|Valdesia",
  ...
  "Alexandria|Aswan|Asyout|Bani Sueif|Beheira|Cairo|Daqahlia|Dumiat|El Bahr El Ahmar|El Ismailia|El Suez|El Wadi El Gedeed|Fayoum|Gharbia|Giza|Helwan|Kafr El Sheikh|Luxor|Matrouh|Menia|Menofia|North Sinai|Port Said|Qalubia|Qena|Sharqia|Sixth of October|Sohag|South Sinai",
  "Ahuachapán|Cabañas|Cuscatlán|Chalatenango|La Libertad|La Paz|La Unión|Morazán|San Miguel|San Salvador|Santa Ana|San Vicente|Sonsonate|Usulután",
  ...
  "Harjumaa (Tallinn)|Hiiumaa (Kardla)|Ida-Virumaa (Johvi)|Järvamaa (Paide)|Jõgevamaa (Jogeva)|Läänemaa|Lääne-Virumaa (Rakvere)|Pärnumaa (Parnu)|Põlvamaa (Polva)|Raplamaa (Rapla)|Saaremaa (Kuessaare)|Tartumaa (Tartu)|Valgamaa (Valga)|Viljandimaa (Viljandi)|Võrumaa (Voru)",
  "Addis Ababa|Afar|Amhara|Benshangul-Gumaz|Dire Dawa|Gambela|Harari|Oromia|Somali|Southern Nations Nationalities and People's Region|Tigray",
  "Falkland Islands (Islas Malvinas)",
  ...
  "Ahvenanmaan lääni|Etelä-Suomen lääni|Itä-Suomen lääni|Länsi-Suomen lääni|Lapin lääni|Oulun lääni",
  ...
  "Abkhazia (Sokhumi)|Ajaria (Bat'umi)|Guria|Imereti|K'akheti|Kvemo Kartli|Mtshkheta-Mtianeti|Rach'a-Lexhkumi-KvemoSvaneti|Samegrelo-Zemo Svaneti|Samtskhe-Javakheti|Shida Kartli|Tbilisi",
  ...
  "Gibraltar",
  "Anatolikí Makedonía kai Thráki|Attikḯ|Dytikí Elláda|Dytikí Makedonía|Ionía Nísia|Kentrikí Makedonía|Krítí|Notío Aigaío|Peloponnísos|Stereá Elláda|Thessalía|Voreío Aigaío|Ípeiros|Ágion Óros",
  "Kommune Kujalleq|Kommuneqarfik Sermersooq|Qaasuitsup Kommunia|Qeqqata Kommunia",
  "Saint Andrew|Saint David|Saint George|Saint John|Saint Mark|Saint Patrick|Southern Grenadine Islands",
  "Guadeloupe",
  "Guam",
  ...
  "Heard Island and McDonald Islands",
  "Holy See (Vatican City)",
  "Atlántida|Choluteca|Colón|Comayagua|Copán|Cortés|El Paraíso|Francisco Morazan|Gracias a Dios|Intibucá|Islas de la Bahía|La Paz|Lempira|Ocotepeque|Olancho|Santa Bárbara|Valle|Yoro",
  "Hong Kong",
  "Bács-Kiskun|Baranya|Békés|Békéscsaba|Borsod-Abauj-Zemplen|Budapest|Csongrád|Debrecen|Dunaújváros|Eger|Érd|Fejér|Győr|Győr-Moson-Sopron|Hajdú-Bihar|Heves|Hódmezővásárhely|Jász-Nagykun-Szolnok|Kaposvár|Kecskemét|Komárom-Esztergom|Miskolc|Nagykanizsa|Nógrád|Nyíregyháza|Pécs|Pest|Salgótarján|Somogy|Sopron|Szabolcs-á-Bereg|Szeged|Székesfehérvár|Szekszárd|Szolnok|Szombathely|Tatabánya|Tolna|Vas|Veszprém|Veszprém (City)|Zala|Zalaegerszeg",
  "Austurland|Höfuðborgarsvæði utan Reykjavíkur|Norðurland eystra|Norðurland vestra|Suðurland|Suðurnes|Vestfirðir|Vesturland",
  ...
  "Alborz|Ardabīl|Āz̄arbāyjān-e Gharbī|Āz̄arbāyjān-e Sharqī|Būshehr|Chahār Maḩāl va Bakhtīārī|Eşfahān|Fārs|Gīlān|Golestān|Hamadān|Hormozgān|Īlām|Kermān|Kermānshāh|Khorāsān-e Jonūbī|Khorāsān-e Raẕavī|Khorāsān-e Shomālī|Khūzestān|Kohgīlūyeh va Bowyer Aḩmad|Kordestān|Lorestān|Markazi|Māzandarān|Qazvīn|Qom|Semnān|Sīstān va Balūchestān|Tehrān|Yazd|Zanjān",
  "Al Anbār|Al Başrah|Al Muthanná|Al Qādisīyah|An Najaf|Arbīl|As Sulaymānīyah|Bābil|Baghdād|Dohuk|Dhī Qār|Diyālá|Karbalā'|Kirkuk|Maysān|Nīnawá|Şalāḩ ad Dīn|Wāsiţ",
  "Carlow|Cavan|Clare|Cork|Donegal|Dublin|Galway|Kerry|Kildare|Kilkenny|Laois|Leitrim|Limerick|Longford|Louth|Mayo|Meath|Monaghan|Offaly|Roscommon|Sligo|Tipperary|Waterford|Westmeath|Wexford|Wicklow",
  "Isle of Man",
  "HaDarom|HaMerkaz|HaTsafon|H̱efa|Tel-Aviv|Yerushalayim",
  ...
  "Jersey",
  "‘Ajlūn|Al 'Aqabah|Al Balqā’|Al Karak|Al Mafraq|Al ‘A̅şimah|Aţ Ţafīlah|Az Zarqā’|Irbid|Jarash|Ma‘ān|Mādabā",
  ...
  "Baringo|Bomet|Bungoma|Busia|Eleyo/Marakwet|Embu|Garissa|Homa Bay|Isiolo|Kajiado|Kakamega|Kericho|Kiambu|Kilifi|Kirinyaga|Kisii|Kisumu|Kitui|Kwale|Laikipia|Lamu|Machakos|Makueni|Mandera|Marsabit|Meru|Migori|Mombasa|Murang'a|Nairobi City|Nakuru|Nandi|Narok|Nyamira|Nyandarua|Nyeri|Samburu|Siaya|Taita/Taveta|Tana River|Tharaka-Nithi|Trans Nzoia|Turkana|Uasin Gishu|Vihiga|Wajir|West Pokot",
  "Abaiang|Abemama|Aranuka|Arorae|Banaba|Beru|Butaritari|Central Gilberts|Gilbert Islands|Kanton|Kiritimati|Kuria|Line Islands|Maiana|Makin|Marakei|Nikunau|Nonouti|Northern Gilberts|Onotoa|Phoenix Islands|Southern Gilberts|Tabiteuea|Tabuaeran|Tamana|Tarawa|Teraina",
  "Chagang-do (Chagang Province)|Hamgyong-bukto (North Hamgyong Province)|Hamgyong-namdo (South Hamgyong Province)|Hwanghae-bukto (North Hwanghae Province)|Hwanghae-namdo (South Hwanghae Province)|Kangwon-do (Kangwon Province)|Nasŏn (Najin-Sŏnbong)|P'yongan-bukto (North P'yongan Province)|P'yongan-namdo (South P'yongan Province)|P'yongyang-si (P'yongyang City)|Yanggang-do (Yanggang Province)",
  "Ch'ungch'ongbuk-do|Ch'ungch'ongnam-do|Cheju-do|Chollabuk-do|Chollanam-do|Inch'on-Kwangyokhi|Kang-won-do|Kwangju-Kwangyokshi|Kyonggi-do|Kyongsangbuk-do|Kyongsangnam-do|Pusan-Kwangyokshi|Seoul-T'ukpyolshi|Sejong|Taegu-Kwangyokshi|Taejon-Kwangyokshi|Ulsan-Kwangyokshi",
  "Al Aḩmadi|Al Farwānīyah|Al Jahrā’|Al ‘Āşimah|Ḩawallī|Mubārak al Kabir",
  ...
  "Attapu|Bokèo|Bolikhamxai|Champasak|Houaphan|Khammouan|Louang Namtha|Louangphabang|Oudômxai|Phôngsali|Salavan|Savannakhét|Vientiane|Xaignabouli|Xékong|Xaisomboun|Xiangkhouang",
  "Aglona|Aizkraukle|Aizpute|Aknīste|Aloja|Alsunga|Alūksne|Amata|Ape|Auce|Ādaži|Babīte|Baldone|Baltinava|Balvi|Bauska|Beverīna|Brocēni|Burtnieki|Carnikava|Cesvaine|Cēsis|Cibla|Dagda|Daugavpils|Daugavpils (City)|Dobele|Dundaga|Durbe|Engure|Ērgļi|Garkalne|Grobiņa|Gulbene|Iecava|Ikšķile|Ilūkste|Inčukalns|Jaunjelgava|Jaunpiebalga|Jaunpils|Jelgava|Jelgava (City)|Jēkabpils|Jēkabpils (City)|Jūrmala (City)|Kandava|Kārsava|Kocēni|Koknese|Krāslava|Krimulda|Krustpils|Kuldīga|Ķegums|Ķekava|Lielvārde|Liepāja|Limbaži|Līgatne|Līvāni|Lubāna|Ludza|Madona|Mazsalaca|Mālpils|Mārupe|Mērsrags|Naukšēni|Nereta|Nīca|Ogre|Olaine|Ozolnieki|Pārgauja|Pāvilosta|Pļaviņas|Preiļi|Priekule|Priekuļi|Rauna|Rēzekne|Rēzekne (City)|Riebiņi|Rīga|Roja|Ropaži|Rucava|Rugāji|Rundāle|Rūjiena|Sala|Salacgrīva|Salaspils|Saldus|Saulkrasti|Sēja|Sigulda|Skrīveri|Skrunda|Smiltene|Stopiņi|Strenči|Talsi|Tērvete|Tukums|Vaiņode|Valka|Valmiera|Varakļāni|Vārkava|Vecpiebalga|Vecumnieki|Ventspils|Ventspils (City)|Viesīte|Viļaka|Viļāni|Zilupe",
  "Aakkâr|Baalbelk-Hermel|Béqaa|Beyrouth|Liban-Nord|Liban-Sud|Mont-Liban|Nabatîyé",
  "Berea|Butha-Buthe|Leribe|Mafeteng|Maseru|Mohales Hoek|Mokhotlong|Qacha's Nek|Quthing|Thaba-Tseka",
  "Bomi|Bong|Gbarpolu|Grand Bassa|Grand Cape Mount|Grand Gedeh|Grand Kru|Lofa|Margibi|Maryland|Montserrado|Nimba|River Cess|River Geee|Sinoe",
  "Al Buţnān|Al Jabal al Akhḑar|Al Jabal al Gharbī|Al Jafārah|Al Jufrah|Al Kufrah|Al Marj|Al Marquab|Al Wāḩāt|An Nuqaţ al Khams|Az Zāwiyah|Banghāzī|Darnah|Ghāt|Mişrātah|Murzuq|Nālūt|Sabhā|Surt|Ţarābulus|Yafran|Wādī ash Shāţiʾ",
  ...
  "Agalega Islands|Beau Bassin-Rose Hill|Black River|Cargados Carajos Shoals|Curepipe|Flacq|Grand Port|Moka|Pamplemousses|Plaines Wilhems|Port Louis (City)|Port Louis|Riviere du Rempart|Rodrigues Island|Savanne|Vacoas-Phoenix",
  "Dzaoudzi|Pamandzi|Mamoudzou|Dembeni|Bandrélé|Kani-Kéli|Bouéni|Chirongui|Sada|Ouangani|Chiconi|Tsingoni|M'Tsangamouji|Acoua|Mtsamboro|Bandraboua|Koungou",
  "Aguascalientes|Baja California|Baja California Sur|Campeche|Ciudad de México|Chiapas|Chihuahua|Coahuila de Zaragoza|Colima|Durango|Estado de México|Guanajuato|Guerrero|Hidalgo|Jalisco|Michoacán de Ocampo|Morelos|Nayarit|Nuevo León|Oaxaca|Puebla|Querétaro de Arteaga|Quintana Roo|San Luis Potosí|Sinaloa|Sonora|Tabasco|Tamaulipas|Tlaxcala|Veracruz|Yucatán|Zacatecas",
  "Chuuk (Truk)|Kosrae|Pohnpei|Yap",
  "Aenii Noi|Basarabeasca|Bălți|Bender|Briceni|Cahul|Cantemir|Călărași|Căușeni|Chișinău|Cimișlia|Criuleni|Dondușeni|Drochia|Dubăsari|Edineț|Fălești|Florești|Găgăuzia|Glodeni|Hîncești|Ialoveni|Leova|Nisporeni|Ocnița|Orhei|Rezina|Rîșcani|Sîngerei|Soroca|Stînga Nistrului|Strășeni|Șoldănești|Ștefan Vodă|Taraclia|Telenești|Ungheni",
  "Colle|Condamine|Fontvieille|Gare|Jardin Exotique|Larvotto|Malbousquet|Monaco-Ville|Moneghetti|Monte-Carlo|Moulins|Port-Hercule|Saint-Roman|Sainte-Dévote|Source|Spélugues|Vallon de la Rousse",
  "Arhangay|Bayan-Olgiy|Bayanhongor|Bulgan|Darhan|Dornod|Dornogovi|Dundgovi|Dzavhan|Govi-Altay|Govi-Sumber|Hovd|Hovsgol|Omnogovi|Ovorhangay|Selenge|Suhbaatar|Tov|Ulaanbaatar|Uvs",
  "Andrijevica|Bar|Berane|Bijelo Polje|Budva|Cetinje|Danilovgrad|Gusinje|Herceg Novi|Kolašin|Kotor|Mojkovac|Nikšić|Petnica|Plav|Plužine|Pljevlja|Podgorica|Rožaje|Šavnik|Tivat|Ulcinj|Žabljak",
  "Saint Anthony|Saint Georges|Saint Peter's",
  "Chaouia-Ouardigha|Doukhala-Abda|Fès-Boulemane|Gharb-Chrarda-Beni Hssen|Grand Casablanca|Guelmim-Es Semara|Laâyoune-Boujdour-Sakia el Hamra|Marrakech-Tensift-Al Haouz|Meknès-Tafilalet|Oriental|Oued ed Dahab-Lagouira|Souss-Massa-Drâa|Tadla-Azilal|Tanger-Tétouan|Taza-Al Hoceima-Taounate",
  ...
  "Erongo|Hardap|Kavango East|Kavango West|Karas|Khomas|Kunene|Ohangwena|Omaheke|Omusati|Oshana|Oshikoto|Otjozondjupa|Zambezi",
  ...
  "Auckland|Bay of Plenty|Canterbury|Gisborne|Hawke's Bay|Marlborough|Manawatu-Wanganui|Northland|Nelson|Otago|Southland|Taranaki|Tasman|Waikato|Wellington|West Coast|Chatham Islands Territory",
  "Boaco|Carazo|Chinandega|Chontales|Estelí|Granada|Jinotega|León|Madriz|Managua|Masaya|Matagalpa|Nueva Segovia|Río San Juan|Rivas|Atlántico Norte|Atlántico Sur",
  ...
  "Akershus|Aust-Agder|Buskerud|Finnmark|Hedmark|Hordaland|Møre og Romsdal|Nordland|Nord-Trøndelag|Oppland|Oslo|Rogaland|Sogn og Fjordane|Sør-Trøndelag|Telemark|Troms|Vest-Agder|Vestfold|Østfold|Jan Mayen|Svalbard",
  "Ad Dakhiliyah|Al Buraymi|Al Wusta|Az Zahirah|Janub al Batinah|Janub ash Sharqiyah|Masqat|Musandam|Shamal al Batinah|Shamal ash Sharqiyah|Zufar",
  "Āzād Kashmīr|Balōchistān|Gilgit-Baltistān|Islāmābād|Khaībar Pakhtūnkhwās|Punjāb|Sindh|Federally Administered Tribal Areas",
  "Aimeliik|Airai|Angaur|Hatobohei|Kayangel|Koror|Melekeok|Ngaraard|Ngarchelong|Ngardmau|Ngatpang|Ngchesar|Ngeremlengui|Ngiwal|Peleliu|Sonsoral",
  "Ak Khalīl|Al Quds|Arīḩā wal Aghwār|Bayt Laḩm|Dayr al Balaḩ|Ghazzah|Janīn|Khān Yūnis|Nāblus|Qalqīyah|Rafaḩ|Rām Allāh wal Bīrah|Salfīt|Shamāl Ghazzah|Ţūbās|Ţūlkarm",
  "Bocas del Toro|Chiriquí|Coclé|Colón|Darién|Emberá|Herrera|Kuna Yala|Los Santos|Ngäbe-Buglé|Panamá|Panamá Oeste|Veraguas",
  "Bougainville|Central|Chimbu|East New Britain|East Sepik|Eastern Highlands|Enga|Gulf|Hela|Jiwaka|Madang|Manus|Milne Bay|Morobe|Port Moresby|New Ireland|Northern|Southern Highlands|West New Britain|West Sepik|Western|Western Highlands",
  "Alto Paraguay|Alto Parana|Amambay|Asuncion|Caaguazu|Caazapa|Canindeyu|Central|Concepcion|Cordillera|Guaira|Itapua|Misiones|Neembucu|Paraguari|Presidente Hayes|San Pedro",
  "Amazonas|Ancash|Apurimac|Arequipa|Ayacucho|Cajamarca|Callao|Cusco|Huancavelica|Huanuco|Ica|Junin|La Libertad|Lambayeque|Lima|Loreto|Madre de Dios|Moquegua|Municipalidad Metropolitana de Lima|Pasco|Piura|Puno|San Martin|Tacna|Tumbes|Ucayali",
  "Abra|Agusan del Norte|Agusan del Sur|Aklan|Albay|Antique|Apayao|Aurora|Basilan|Bataan|Batanes|Batangas|Benguet|Biliran|Bohol|Bukidnon|Bulacan|Cagayan|Camarines Norte|Camarines Sur|Camiguin|Capiz|Catanduanes|Cavite|Cebu|Compostela|Cotabato|Davao del Norte|Davao del Sur|Davao Occidental|Davao Oriental|Dinagat Islands|Eastern Samar|Guimaras|Ifugao|Ilocos Norte|Ilocos Sur|Iloilo|Isabela|Kalinga|La Union|Laguna|Lanao del Norte|Lanao del Sur|Leyte|Maguindanao|Masbate|Mindoro Occidental|Mindoro Oriental|Misamis Occidental|Misamis Oriental|Mountain Province|Negros Occidental|Negros Oriental|Northern Samar|Nueva Ecija|Nueva Vizcaya|Palawan|Pampanga|Pangasinan|Quezon|Quirino|Rizal|Romblon|Samar|Sarangani|Siquijor|Sorsogon|Southern Leyte|Sultan Kudarat|Sulu|Surigao del Norte|Surigao del Sur|Tarlac|Tawi-Tawi|Zambales|Zamboanga del Norte|Zamboanga del Sur|Zamboanga Sibugay",
  "Pitcairn Islands",
  "Dolnośląskie|Kujawsko-pomorskie|Łódzkie|Lubelskie|Lubuskie|Malopolskie|Mazowieckie|Opolskie|Podkarpackie|Podlaskie|Pomorskie|Śląskie|Świętokrzyskie|Warmińsko-mazurskie|Wielkopolskie|Zachodniopomorskie",
  "Acores|Aveiro|Beja|Braga|Braganca|Castelo Branco|Coimbra|Evora|Faro|Guarda|Leiria|Lisboa|Madeira|Portalegre|Porto|Santarem|Setubal|Viana do Castelo|Vila Real|Viseu",
  ...
  "Principe|Sao Tome",
  "'Asir|Al Bahah|Al Hudud ash Shamaliyah|Al Jawf|Al Madinah al Munawwarah|Al Qasim|Ar Riyad|Ash Sharqiyah|Ha'il|Jazan|Makkah al Mukarramah|Najran|Tabuk",
  ...
  "Anse aux Pins|Anse Boileau|Anse Etoile|Anse Royale|Anu Cap|Baie Lazare|Baie Sainte Anne|Beau Vallon|Bel Air|Bel Ombre|Cascade|Glacis|Grand'Anse Mahe|Grand'Anse Praslin|La Digue|La Riviere Anglaise|Les Mamelles|Mont Buxton|Mont Fleuri|Plaisance|Pointe La Rue|Port Glaud|Roche Caiman|Saint Louis|Takamaka",
  ...
  "Basnahira|Dakunu|Madhyama|Naegenahira|Sabaragamuwa|Uturu|Uturumaeda|Vayamba|Uva",
  "Al Bahr al Ahmar|Al Jazirah|Al Khartum|Al Qadarif|An Nil al Abyad|An Nil al Azraq|Ash Shamaliyah|Gharb Darfur|Gharb Kurdufan|Janub Darfur|Janub Kurdufan|Kassala|Nahr an Nil|Shamal Darfur|Sharq Darfur|Shiamal Kurdufan|Sinnar|Wasat Darfur Zalinjay",
  "Brokopondo|Commewijne|Coronie|Marowijne|Nickerie|Para|Paramaribo|Saramacca|Sipaliwini|Wanica",
  "Hhohho|Lubombo|Manzini|Shiselweni",
  "Blekinge|Dalarnas|Gotlands|Gavleborgs|Hallands|Jamtlands|Jonkopings|Kalmar|Kronobergs|Norrbottens|Orebro|Ostergotlands|Skane|Sodermanlands|Stockholm|Varmlands|Vasterbottens|Vasternorrlands|Vastmanlands|Vastra Gotalands",
  "Aargau|Appenzell Ausserrhoden|Appenzell Innerhoden|Basel-Landschaft|Basel-Stadt|Bern|Fribourg|Genève|Glarus|Graubünden|Jura|Luzern|Neuchâtel|Nidwalden|Obwalden|Sankt Gallen|Schaffhausen|Schwyz|Solothurn|Thurgau|Ticino|Uri|Valais|Vaud|Zug|Zürich",
  ...
  "Chang-hua|Chia-i|Hsin-chu|Hua-lien|Kao-hsiung|Keelung|Kinmen|Lienchiang|Miao-li|Nan-t'ou|P'eng-hu|New Taipei|P'ing-chung|T'ai-chung|T'ai-nan|T'ai-pei|T'ai-tung|T'ao-yuan|Yi-lan|Yun-lin",
  "Dushanbe|Kŭhistoni Badakhshon|Khatlon|Sughd",
  "Arusha|Coast|Dar es Salaam|Dodoma|Iringa|Kagera|Kigoma|Kilimanjaro|Lindi|Manyara|Mara|Mbeya|Morogoro|Mtwara|Mwanza|Pemba North|Pemba South|Rukwa|Ruvuma|Shinyanga|Singida|Tabora|Tanga|Zanzibar North|Zanzibar Central/South|Zanzibar Urban/West",
  "Amnat Charoen|Ang Thong|Bueng Kan|Buri Ram|Chachoengsao|Chai Nat|Chaiyaphum|Chanthaburi|Chiang Mai|Chiang Rai|Chon Buri|Chumphon|Kalasin|Kamphaeng Phet|Kanchanaburi|Khon Kaen|Krabi|Krung Thep Mahanakhon (Bangkok)|Lampang|Lamphun|Loei|Lop Buri|Mae Hong Son|Maha Sarakham|Mukdahan|Nakhon Nayok|Nakhon Phathom|Nakhon Phanom|Nakhon Ratchasima|Nakhon Sawan|Nakhon Si Thammarat|Nan|Narathiwat|Nong Bua Lam Phu|Nong Khai|Nonthaburi|Pathum Thani|Pattani|Phangnga|Phatthalung|Phayao|Phetchabun|Phetchaburi|Phichit|Phitsanulok|Phra Nakhon Si Ayutthaya|Phrae|Phuket|Prachin Buri|Prachuap Khiri Khan|Ranong|Ratchaburi|Rayong|Roi Et|Sa Kaeo|Sakon Nakhon|Samut Prakan|Samut Sakhon|Samut Songkhram|Saraburi|Satun|Sing Buri|Si Sa ket|Songkhla|Sukhothai|Suphan Buri|Surat Thani|Surin|Tak|Trang|Trat|Ubon Ratchathani|Udon Thani|Uthai Thani|Uttaradit|Yala|Yasothon",
  ...
  "Arima|Chaguanas|Couva-Tabaquite-Talparo|Diefo Martin|Mayaro-Rio Claro|Penal-Debe|Point Fortin|Port-of-Spain|Princes Town|San Fernando|San Juan-Laventille|Sangre Grande|Siparia|Tobago|Tunapuna-Piarco",
  "Ariana|Beja|Ben Arous|Bizerte|Gabes|Gafsa|Jendouba|Kairouan|Kasserine|Kebili|Kef|Mahdia|Medenine|Monastir|Nabeul|Sfax|Sidi Bouzid|Siliana|Sousse|Tataouine|Tozeur|Tunis|Zaghouan",
  ...
  "Ahal|Asgabat|Balkan|Dashoguz|Lebap|Mary",
  "Turks and Caicos Islands",
  ...
  "Cherkasy|Chernihiv|Chernivtsi|Dnipropetrovsk|Donetsk|Ivano-Frankivsk|Kharkiv|Kherson|Khmelnytskyi|Kiev|Kirovohrad|Luhansk|Lviv|Mykolaiv|Odessa|Poltava|Rivne|Sumy|Ternopil|Vinnytsia|Volyn|Zakarpattia|Zaporizhia|Zhytomyr|Avtonomna Respublika Krym|Kyïv|Sevastopol",
  ...
  "Toshkent shahri|Andijon|Buxoro|Farg‘ona|Jizzax|Namangan|Navoiy|Qashqadaryo (Qarshi)|Samarqand|Sirdaryo (Guliston)|Surxondaryo (Termiz)|Toshkent wiloyati|Xorazm (Urganch)|Qoraqalpog‘iston Respublikasi (Nukus)",
  "Malampa|Pénama|Sanma|Shéfa|Taféa|Torba",
  "Dependencias Federales|Distrito Federal|Amazonas|Anzoátegui|Apure|Aragua|Barinas|Bolívar|Carabobo|Cojedes|Delta Amacuro|Falcón|Guárico|Lara|Mérida|Miranda|Monagas|Nueva Esparta|Portuguesa|Sucre|Táchira|Trujillo|Vargas|Yaracuy|Zulia",
  "Đồng Nai|Đồng Tháp|Gia Lai|Hà Giang|Hà Nam|Hà Tây|Hà Tĩnh|Hải Dương|Hậu Giang|Hòa Bình|Hưng Yên|Khánh Hòa|Kiên Giang|Kon Tum|Lai Châu|Lâm Đồng|Lạng Sơn|Lào Cai|Long An|Nam Định|Nghệ An|Ninh Bình|Ninh Thuận|Phú Thọ|Phú Yên|Quảng Bình|Quảng Nam|Quảng Ngãi|Quảng Ninh|Quảng Trị|Sóc Trăng|Sơn La|Tây Ninh|Thái Bình|Thái Nguyên|Thanh Hóa|Thừa Thiên–Huế|Tiền Giang|Trà Vinh|Tuyên Quang|Vĩnh Long|Vĩnh Phúc|Yên Bái|Cần Thơ|Đà Nẵng|Hà Nội|Hải Phòng|Hồ Chí Minh (Sài Gòn)",
  "Anegada|Jost Van Dyke|Tortola|Virgin Gorda",
  "St. Thomas|St. John|St. Croix",
  "Alo|Sigave|Wallis",
  "Es Smara|Boujdour|Laâyoune|Aousserd|Oued ed Dahab",
  "Abyān|'Adan|Aḑ Ḑāli'|Al Bayḑā'|Al Ḩudaydah|Al Jawf|Al Mahrah|Al Maḩwīt|'Amrān|Dhamār|Ḩaḑramawt|Ḩajjah|Ibb|Laḩij|Ma'rib|Raymah|Şā‘dah|Şan‘ā'|Shabwah|Tā‘izz",
...
function populateIndianStates(stateElementId) {
    
        var selectedCountryIndex = 103;
...
function populateSelCountryState(countryElementId, stateElementId) {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    console.log(selectedCountryIndex)
    var stateElement = document.getElementById(stateElementId);
