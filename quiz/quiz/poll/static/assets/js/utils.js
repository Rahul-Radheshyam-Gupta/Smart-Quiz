                    ...
                    if (e.which >= keys.SPACE && !e.metaKey && window.intlTelInputUtils && !that.telInput.prop("readonly")) {
                        ...
                        if (isBelowMax && (isAllowedKey || noSelection)) {
                            ...
                            if (val != that.telInput.val()) {
                                that.telInput.trigger("#user-mobile");
                                that.telInput.trigger("#user-mobile1");
                                /*that.telInput.trigger("#mobile_number_1");
                                that.telInput.trigger("#mobile_number_2");*/
                            }
                        }
                        if (!isAllowedKey) {
