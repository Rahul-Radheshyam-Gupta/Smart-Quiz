...
$(document).ready(function(){
	...
	$('#tn-custom').fullCalendar({
		...
		select: function(start, end) {
			...
			if (title) {
				...
				$('#tn-custom').fullCalendar('renderEvent', eventData, true); // stick? = true
			}
			$('#tn-custom').fullCalendar('unselect');
		},
	...
	************************************/
	$('#fc-json').fullCalendar({
		...
		eventLimit: true, // allow "more" link when too many events
		events: {
			url: 'static/app/robust-assets/demo-data/fullcalendar/php/get-events.php',
			error: function() {
				$('#script-warning').show();
			}
		},
	...
	****************************************/
	...
	/*$.getJSON('static/app/robust-assets/demo-data/fullcalendar/php/get-timezones.php', function(timezones) {
