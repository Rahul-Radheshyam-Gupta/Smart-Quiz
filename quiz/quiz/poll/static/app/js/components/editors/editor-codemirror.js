...
(function(window, document, $) {
	...
	$('#select').change(function () {
		...
		stylesheet.attr('href','../../../robust-assets/css/plugins/editors/theme/'+selectedTheme.toLowerCase()+'.css');
	...
	CodeMirror.modeURL = "../../../robust-assets/js/plugins/editors/codemirror/mode/*/*.js";
