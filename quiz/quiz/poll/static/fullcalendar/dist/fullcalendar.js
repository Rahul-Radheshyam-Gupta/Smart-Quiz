...
// Given a total available height to fill, have `els` (essentially child rows) expand to accommodate.
...
DayGrid.mixin({
	...
	// Computes the number of levels a row will accommodate without going outside its bounds.
