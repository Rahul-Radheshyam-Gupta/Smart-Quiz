...
(function(window, document, $) {
  ...
  var countries = new Bloodhound({
    ...
    prefetch: '../../../robust-assets/demo-data/countries.json'
  ...
  var bestPictures = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../robust-assets/demo-data/films/post_1960.json',
    remote: {
      url: '../../../robust-assets/demo-data/films/queries/%QUERY.json',
      wildcard: '%QUERY'
    }
  });
  ...
  var nflTeams = new Bloodhound({
    ...
    prefetch: '../../../robust-assets/demo-data/nfl.json'
  });
  ...
  var nbaTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../robust-assets/demo-data/nba.json'
  });

  var nhlTeams = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: '../../../robust-assets/demo-data/nhl.json'
  });
