...
(function(window, document, $) {
    ...
    $('#time-intime').datetimepicker({
       format: 'LT'
    });
    
      //With some format
	$('#time-outtime').datetimepicker({
        format: 'LT'
	});

	$('#hrs-min').datetimepicker({
		format: 'HH:mm'
	});
	...
	$('#pre-shift-time').datetimepicker({
		format: 'HH:mm'
	});

	$('#post-shift-time').datetimepicker({
		format: 'HH:mm'
	});

	$('#break-duration').datetimepicker({
		format: 'HH:mm'
	});
	
$('#regularize-intime').datetimepicker({
    format: 'LT'
	});

$('#regularize-outtime').datetimepicker({
    format: 'LT'
	});

$('#regularize-intime2').datetimepicker({
   format: 'LT'
	});

$('#regularize-outtime2').datetimepicker({
   format: 'LT'
});

/*
var tpicker = timepicker.pickatime('picker');
tpicker.set('highlight', 1080).set('view', 1080);;
