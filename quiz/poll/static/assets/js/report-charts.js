...
google.charts.load('current', {'packages':['corechart'],"callback": chart001});
...
// Used for Bar Chart expense (1 of 3)
    ...
    $('#chart-area-1').addClass('col-sm-4')
    var chart = new google.visualization.BarChart(document.getElementById('chart-area-1'));
...
// Used for Bar Chart expense (2 of 3)
    ...
    $('#chart-area-2').addClass('col-sm-4')
    var chart = new google.visualization.BarChart(document.getElementById('chart-area-2'));
...
// Used for Bar Chart expense (3 of 3)
    ...
    $('#chart-area-3').addClass('col-sm-4')
    var chart = new google.visualization.BarChart(document.getElementById('chart-area-3'));
...
// function related to bubble chart attendance (punchin)
    ...
    var ticks = []
    ticks[0] = 0
    for (var i=1,j=1;i<=max;i++,j+=24){
        // console.log(i+" "+j+" "+data[j][1])
        ticks [i] = data[j][1];
        // console.log(ticks [i])
    }
    ...
    for (var i=1;i<data.length;i++){
        ...
        // data[i][2] = [x.getDay().toString(),x.getHours(),x.getMinutes(),x.getSeconds()]
    ...
    function handler1(e) {
        ...
        if(data[index][3]!=0){
            console.log("data to plot ",data[index][3])
...
// function for bubble chart expense
    ...
    var options_area = {
        ...
        function handler1(e) {
            ...
            // console.log(index)
            // console.log('Data',data)
            $('#custom_tooltip').html('<div class="google-visualization-tooltip-item"><p class="font-medium-2">Month : ' + '<b>'+months[data[index][1]-1]+'</b></p>' + '<p class="font-medium-2">Total Expense : ' + '<b>'+data[index][2]+'</b></p>' + '<p class="font-medium-2">No. of Requests : ' + '<b>'+data[index][4]+'</b></p>' +'</div>').css({
                'top': y,
                'left': x
            }).fadeIn('fast');
        }
...
// Used for calendar chrt leave
     ...
     var options_area = {
       ...
       google.visualization.events.addListener(chart, 'ready', function () {
        $($('#chart-area text')[0]).text('');
        $($('#chart-area text')[1]).text('');
        $($('#chart-area text')[2]).text('');
        /*$('#chart-area path')[0].setAttribute("d",'');*/
        /*$('#chart-area path')[1].setAttribute("d",'');*/
        $('#chart-area path')[1].setAttribute("fill",'#fff');
        $('#chart-area path')[1].setAttribute("stroke",'#fff');
        $('#chart-area path')[2].setAttribute("stroke",'#fff');
         $('#chart-area path')[2].setAttribute("fill",'#fff');
       /* $('#chart-area path')[2].setAttribute("d","#fff");*/
        // console.log($('#chart-area path')[2])
...
// function for pie chart leave
    ...
    for (i=0;i<length_div;i++)
    {
        ...
        {   //no data being paased
            ...
            // google.visualization.events.addListener(chart[i], 'ready', function(e) {
            //     if (leave_obj[i][0][0] != ''){
...
function chart031(data, extra_parameters) {
    // gantt chart
    var option = {}
    return [data,option]
  }
